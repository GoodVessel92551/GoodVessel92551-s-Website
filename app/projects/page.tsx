  ...
  return (
    <div>
      ...
      <div className='projects'>
        <Project url="https://code.booogle.app" title='Code Classroom' alt='code classroom' image='/project_images/CodeClassroom.webp' description='Code Classroom is a website that helps teachers teacher there students to code. It allow for teachers to set and students to complete task to help there learning.'></Project>
